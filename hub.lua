...
-- Main 
if game.PlaceId == 81440632616906 then -- dig to earths core
    pcall(function()
...
elseif game.PlaceId == 5256165620 then -- 3 2 1 blast off simulator
    pcall(function()
...
elseif game.PlaceId == 75663528075786 then -- how to train ur dragon (barely supported)
    pcall(function()
...
elseif game.PlaceId == 13461044782 then -- every seacond you jump higher
    pcall(function()
